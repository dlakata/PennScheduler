...
for course in schedule_courses[1:]:
	test.setdefault(course, []).append(schedule_courses[0])
...
# common = list(set(prakhar_courses) & set(adel_courses) & set(schedule_courses))
# print common		
